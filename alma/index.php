    ...
    <section class="webdoor">
        <div class="center">
            <div class="left">
                ...
                <h3 class="subtitulo">Invista no Mar<br>Invista da Lagoa.</h3>
            ...
            <div class="right">
                <div class="wrapForm" id="formulario">
                    ...
                    <form id="formularioTopo" action="envia.php" method="post">
                        ...
                        <input type="hidden" id="interesse" name="interesse" value="Alma">
            ...
            <div class="wrapPoints">
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Rentabilidade garantida 1º ano</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Entrada facilitada</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Financiamento garantido</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Fluxo de 30% durante a obra.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="mosaico">
        <div class="centerMosaico">
            <div class="left">
                ...
                <p class="content">Escolha a elegância. Escolha o charme. Escolha 
o Alma Ipanema.<br><br>Apartamentos e coberturas com Up garden, lazer completo, piscina no rooftop e vista para o mar, <b>perfeito para você morar, investir ou se hospedar.</b> Tudo com entrada facilitada e financiamento garantido.</p>
