    ...
    <section class="webdoor">
        <div class="center">
            <div class="left">
                ...
                <h3 class="subtitulo">Empreendimento exclusivo ao lado do Metrô e com lazer completo.</h3>
            ...
            <div class="right">
                <div class="wrapForm" id="formulario">
                    ...
                    <form id="formularioTopo" action="envia.php" method="post">
                        ...
                        <input type="hidden" id="interesse" name="interesse" value="Ornato">
            ...
            <div class="wrapPoints">
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Apartamentos com 2 e 3 quartos</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Lazer completo, com piscina, espaço kids, academia, e muito mais</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Pagamento facilitado.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="mosaico">
        <div class="centerMosaico">
            <div class="left">
                ...
                <p class="content">Ornato é o seu novo lar na Tijuca.<br><br>

Projetado para você vivenciar as melhores recordações. Com espaços modernos, integrados e arejados, com Up Gardens e apartamentos de 2 e 3 quartos, com lazer completo para todos os gostos: piscina, sauna, terraço gourmet, pet care, coworking, brinquedoteca e muito mais.</p>

                <a href="#formulario"><div class="btn btnCta">Conheça seu novo endereço!</div></a>
            </div>
            <div class="right">
