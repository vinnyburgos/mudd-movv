                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/zenture.png" alt=""></div>
                                <div class="innerContent">
                                    <h4>Zenture - Botafogo</h4>
                                    <div class="lineOrange"></div>
                                    <p class="ponto"><img src="images/tickSlide.png" alt="">3 e 4 quartos com suítes</p>
                                    ...
                                    <a id="btnZenture" href="#formulario"><div class="btn btnSaiba">Saiba mais<img src="images/setaSaiba.png" alt=""></div></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/sdesign.png" alt=""></div>
                                <div class="innerContent">
                                    <h4>S Design - Botafogo</h4>
                                    <div class="lineOrange"></div>
                                    ...
                                    <p class="ponto"><img src="images/tickSlide.png" alt="">2 vagas na garagem</p>
                                    <a id="btnSDesign" href="#formulario"><div class="btn btnSaiba">Saiba mais<img src="images/setaSaiba.png" alt=""></div></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/ornato.png" alt=""></div>
                                <div class="innerContent">
                                    <h4>Ornato - Tijuca</h4>
                                    <div class="lineOrange"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/nurban.png" alt=""></div>
                                <div class="innerContent">
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/blanc.png" alt=""></div>
                                <div class="innerContent">
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/alma.png" alt=""></div>
                                <div class="innerContent">
                                    <h4>Alma - Ipanema</h4>
                                    <div class="lineOrange"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/gloria.png" alt=""></div>
                                <div class="innerContent">
                        ...
                        <div class="swiper-slide">
                            <div class="box">
                                <div class="imgTop"><img src="../imgSlides/tie.png" alt=""></div>
                                <div class="innerContent">
...
<script>
    ...
    sdesign  = document.getElementById("btnSDesign");
    vistaIpanema  = document.getElementById("btnVista");
    zenture  = document.getElementById("btnZenture");

    zenture.addEventListener("mousemove", function(){
        interesse.value = "Zenture";
    });
    sdesign.addEventListener("mousemove", function(){
        interesse.value = "SDesign";
    });
