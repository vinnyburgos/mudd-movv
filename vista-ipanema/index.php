    ...
    <section class="webdoor">
        <div class="center">
            <div class="left">
                ...
                <h3 class="subtitulo">MELHOR ÂNGULO DE<br>IPANEMA SERÁ A SUA VISTA!</h3>
            ...
            <div class="right">
                <div class="wrapForm" id="formulario">
                    ...
                    <form id="formularioTopo" action="envia.php" method="post">
                        ...
                        <input type="hidden" id="interesse" name="interesse" value="Vista Ipanema">
            ...
            <div class="wrapPoints">
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Conforto, elegância, segurança 
e exclusividade</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Apartamentos de 173m² ou 346m²</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>3 a 6 vagas na garagem</p>
                    </div>
                </div>
            </div>
...
Empreendimento inédito que a sua família merece com muito modernidade, tecnologia, lazer e segurança.<br><br>

Vista Ipanema é um empreendimento que valoriza todo o charme que só quem é morador do bairro entende. Com opções de Up Gardens, apartamentos e coberturas, as unidades contam com box exclusivo, infraestrutura para adega, portaria com sistema de segurança e lazer completo. </p>

                <a href="#formulario"><div class="btn btnCta">Conheça seu próximo endereço!</div></a>
            </div>
            <div class="right">
