    ...
    <section class="webdoor">
        <div class="center">
            <div class="left">
                ...
                <h3 class="subtitulo">Desfrute de uma vida de exclusividade feita para você no
                    <b> S DESIGN em Botafogo</b></h3>
            ...
            <div class="right">
                <div class="wrapForm" id="formulario">
                    ...
                    <form id="formularioTopo" action="envia.php" method="post">
                        ...
                        <input type="hidden" id="interesse" name="interesse" value="SDesign">
            ...
            <div class="wrapPoints">
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>3 suítes e de 4 quartos</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>150m2 a 166m2</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Varandas gourmet</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Churrasqueira a gás</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>Cortina de vidro com fechamento retrátil</p>
                    </div>
                </div>
                <div class="point">
                    <div class="innerIntegral innerPoint">
                        <img src="images/tickTopo.png" alt="tick"><p>2 vagas</p>
                    </div>
                </div>
    ...
    <section class="mosaico">
        <div class="centerMosaico">
            <div class="left">
                ...
                <p class="content">Explore o conforto e sofisticação do S Design Residencial em Botafogo!<br><br>
                
                Unidades de 3 e 4 quartos, 150m2 a 166m2, varandas gourmet, churrasqueira a gás, cortina de vidro retrátil e muito mais.<br><br>
            
                Desfrute de uma vida de exclusividade, com comodidades modernas como interruptores smart, tomada com saída USB e fechadura biométrica. Um lar inspirado na beleza e acolhimento carioca, aguarda você no coração de Botafogo, cercado de charme e tranquilidade.<br><br>
